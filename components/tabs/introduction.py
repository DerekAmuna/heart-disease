    ...
    return dbc.Container([
                ...
                dbc.Card([
                    ...
                    dbc.CardBody([
                        ...
                        html.Ul([
                            ...
                            html.Li("Color-coded intensity representation"),
            ...
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                html.H5("Countries", className="text-center"),
                                html.H3("194", className="text-center text-primary")
                            ], width=4),
                            dbc.Col([
                            ...
                            dbc.Col([
                                ...
                                html.H3("50K+", className="text-center text-primary")
                            ], width=4)
                        ])
                    ])
                ], className="shadow-sm")
        ...
        dbc.Row([
           ...
           className="mt-3")
                            ...
                            dbc.Col([
                                html.Div([
                                    html.I(className="fas fa-heartbeat fa-5x text-danger"),
...
>>>>>>> f4d67597356dcfdc62e8c00e7efea22328c2738a
