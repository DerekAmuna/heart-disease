...
# #     #                     dbc.CardBody(create_scatter_plot("gdp_pc", "death_std", df, top_n=top_n),style={"height": "400px"}),
# #     #                 ], className="mb-3 shadow-sm"),
# #     #                 width=12,
# #     #             ),
...
# #                     dbc.CardHeader(html.H4("GDP vs Death Rate", className="text-center")),
# #                     dbc.CardBody(
# #                         dcc.Graph(figure=create_scatter_plot("gdp_pc", "death_std", df, top_n=top_n), style={"height": "400px"})
# #                     ),
# #                 ], className="mb-3 shadow-sm"),
# #                 width=12,
# #             ),
...
# #                     dbc.CardHeader(html.H4("Population Growth Over Time", className="text-center")),
# #                     dbc.CardBody(
# #                         dcc.Graph(figure=create_line_plot("Population", data, countries=selected_countries, top_n=top_n), style={"height": "400px"})
# #                     ),
# #                 ], className="mb-3 shadow-sm"),
# #                 width=12,
# #             ),
...
# #                     dbc.CardHeader(html.H4(f"{metric} Distribution", className="text-center")),
# #                     dbc.CardBody(
# #                         dcc.Graph(figure=create_bar_plot(col, df, top_n=top_n), style={"height": "400px"})
# #                     ),
# #                 ], className="mb-3 shadow-sm"),
# #                 width=12,
# #             ),
...
# #                     dbc.CardHeader(html.H4("Male vs Female Deaths", className="text-center")),
# #                     dbc.CardBody(
# #                         dcc.Graph(figure=create_scatter_plot("f_deaths", "m_deaths", df), style={"height": "400px"})
# #                     ),
# #                 ], className="mb-3 shadow-sm"),
# #                 width=12,
# #             ),
...
# #                     dbc.CardHeader(html.H4("GDP vs Death Rate", className="text-center")),
# #                     dbc.CardBody(create_scatter_plot("gdp_pc", "death_std", df, top_n=top_n)),
# #                 ], className="h-100 mb-3 shadow-sm"),
# #                 width=6
# #             ),
# #             dbc.Col(
# #                 dbc.Card([
